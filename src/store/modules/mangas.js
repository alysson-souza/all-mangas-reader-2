...
const mutations = {
     ...
     */
    resetManga(state, { url, mirror, language }, rootState) {
        const key = mangaKey({
            url: url,
            mirror: mirror,
            language: language,
            mirrors: rootState.mirrors.all
        })
     ...
     * @param {*} param1 url of the manga
     */
    saveCurrentState(state, { url, mirror, language, currentChapter, currentScanUrl }, rootState) {
        const key = mangaKey({
            url: url,
            mirror: mirror,
            language: language,
