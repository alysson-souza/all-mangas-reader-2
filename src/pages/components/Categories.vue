    ...
    <v-card>
      ...
      <v-dialog v-model="deleteCatDialog" max-width="290">
        <v-card>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="red darken-1" text @click.native="reallyDeleteCat()">{{i18n("button_yes")}}</v-btn>
            <v-btn color="grey darken-1" text @click.native="deleteCatDialog = false">{{i18n("button_no")}}</v-btn>
          </v-card-actions>
        </v-card>
      </v-dialog>
      ...
      <v-dialog v-model="editCatDialog" max-width="290">
        <v-card>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="red darken-1" :disabled="!isValidEditName" text @click.native="submitEditCategory()">
              {{i18n("button_yes")}}
            </v-btn>
            <v-btn color="grey darken-1" text @click.native="editCatDialog = false">{{i18n("button_no")}}</v-btn>
          </v-card-actions>
        </v-card>
      </v-dialog>
    </v-card>
