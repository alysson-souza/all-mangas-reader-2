if (typeof registerMangaObject === 'function') {
    registerMangaObject({
        ...
        getListImages: async function(doc, curUrl) {
            ...
            $(
                '#router-view > div > div.ui.grid.chapter > div.ch-images.ch-image-container > center > img',
                doc
            ).each(function() {
            ...
            $(
                '#router-view > div > div.ui.grid.chapter > div.ch-images.ch-image-container > center > a > img', doc
            ).each(function() {
                res.push('https://readm.org' + $(this).attr('src'));
            });
